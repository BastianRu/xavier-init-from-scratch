...
> You could think that these problems are derived from entropy. But as we will see, it is not so, they do not occur by chance, but by the very nature of the functions we choose. As the Merovingian from the Matrix saga says: **"Where others see chance, I see causality"**.
